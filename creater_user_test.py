...
# Функция для позитивной проверки   1 задание
#def positive_assert(first_name):
    # В переменную user_body сохраняется обновленное тело запроса
    #user_body = get_user_body(first_name)
    # В переменную user_response сохраняется результат запроса на создание пользователя:
    #user_response = sende_stand_request.post_new_user(user_body)
    ...
    #users_table_response = sende_stand_request.get_users_table()
...
# Функция для позитивной проверки  2 задание
#def positive_assert(first_name):
    # В переменную user_body сохраняется обновленное тело запроса
   # user_body = get_user_body(first_name)
    # В переменную user_response сохраняется результат запроса на создание пользователя:
...
#def test_create_user_15_letter_in_first_name_get_success_response():
 ...
 #Функция для негативной 3 задание проверки 1вариает

#def negative_assert_symbol(first_name):

    #user_body = get_user_body(first_name)

    #response = sende_stand_request.post_new_user(user_body)
    ...
    #users_table_response = sende_stand_request.get_users_table()
    #str_user = user_body["firstName"] + "," + user_body["phone"] + "," + user_body["address"] + ",,," + response.json()["authToken"]
...
#def test_create_user_1_letter_in_first_name_get_success_response():
 ...
 # Функция для негативной проверки третье задание 2 вториант
#def negative_assert_symbol(first_name):
...
#def test_create_user_1_letter_in_first_name_get_success_response():
 ...
 # Функция для негативной проверки 4 задание
#def negative_assert_symbol(first_name):
        # В переменную user_body сохраняется обновлённое тело запроса
    #user_body = get_user_body(first_name)
...
#def test_create_user_16_letter_in_first_name_get_error_response():
    ...
    # Функция для позитивной проверки 5 задание
...
def test_create_user_2_letter_in_first_name_get_success_response():
    positive_assert("QWErty")
        ...
        #6 Задание успешное создание Мария
